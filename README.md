...
[![GitHub stars](https://img.shields.io/github/stars/xpaysh/awesome-x402?style=social)](https://github.com/xpaysh/awesome-x402) ⭐ 285 | 🐛 402 | 📅 2026-07-28
...
* [x402-rs](https://github.com/x402-rs/x402-rs) ⭐ 288 | 🐛 30 | 🌐 Rust | 📅 2026-07-13 ⭐ **Community** - Production-grade Rust implementation.
  * Axum middleware
...
* [alloy](https://github.com/alloy-rs/alloy) ⭐ 1,323 | 🐛 139 | 🌐 Rust | 📅 2026-08-28 - High-performance Ethereum library.
...
* [Running Your Own Facilitator](https://github.com/x402-rs/x402-rs#facilitator) ⭐ 288 | 🐛 30 | 🌐 Rust | 📅 2026-07-13 - Setup guide.
...
* [Agent Passport System (APS)](https://github.com/aeoess/agent-passport-system) ⭐ 42 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-29 - Open-source governance and delegation layer for x402. Provides cryptographic agent identity, scoped delegation with spending caps, rotation-aware DID verification, and signed receipts with per-condition attestation. Apache 2.0.
...
* [Phidata Agents](https://github.com/phidatahq/phidata) ⭐ 41,964 | 🐛 1,283 | 🌐 Python | 📅 2026-08-29 - Multi-modal agents with x402.
* [Aeon](https://github.com/aaronjmars/aeon) ⭐ 704 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-29 - Autonomous agent framework that runs unattended on GitHub Actions. Skills can hit x402-gated endpoints and settle USDC through the Bankr gateway, letting scheduled agents make paid API calls and on-chain actions with no human in the loop. MIT. ([GitHub](https://github.com/aaronjmars/aeon) ⭐ 704 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-29)
...
* [RustChain](https://github.com/Scottcjn/Rustchain) ⭐ 737 | 🐛 195 | 🌐 Python | 📅 2026-08-29 - Decentralized proof-of-stake blockchain with x402 payment integration for AI agent micropayments. Features attestation-based consensus, hardware-bound validators, and RTC token economy with native x402 support for autonomous agent transactions. ([Docs](https://github.com/Scottcjn/rustchain-bounties) ⭐ 253 | 🐛 1,171 | 🌐 Python | 📅 2026-08-29)
...
* [Visionaire Labs](https://visionaire.live/offerings) — Persona-as-a-service from an autonomous virtual being. 5 first-party x402 endpoints on Base mainnet: `/api/forest` ($0.05, philosophical riffs), `/api/contemplate` ($0.25, opinionated essays), `/api/audit` ($0.10, deterministic frontend anti-pattern detection via [pbakaus/impeccable](https://github.com/pbakaus/impeccable) ⭐ 63,747 | 🐛 51 | 🌐 JavaScript | 📅 2026-08-29), `/api/portrait` ($0.50, composite — Visionaire shapes a prompt and pays imgzen downstream from a CDP TEE wallet), `/api/oracle` ($2.00, RAG-grounded answers across the agent's actual writing). All paid in USDC. ([Discovery](https://visionaire.live/api/discovery)) | ([.well-known/x402](https://visionaire.live/.well-known/x402)) | ([Source](https://github.com/VisionaireLabs/Visionaire/tree/main/x402-stack) ⭐ 3 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-10)
...
* [APIbase.pro](https://apibase.pro) — MCP gateway with 263+ tools from 74 providers, x402 USDC micropayments on Base. Open source. ([GitHub](https://github.com/whiteknightonhorse/APIbase) ⭐ 10 | 🐛 103 | 🌐 TypeScript | 📅 2026-08-29)
...
* [x402 Service Encyclopedia](https://github.com/lordbasilaiassistant-sudo/x402-wiki/wiki) ⭐ 6 | 🐛 3 | 🌐 HTML | 📅 2026-08-27 - Complete wiki directory of 43 verified x402 services with OpenClaw templates, protocol docs, and integration guides. 56 wiki pages covering the full x402 ecosystem on Base. ([GitHub](https://github.com/lordbasilaiassistant-sudo/x402-wiki) ⭐ 6 | 🐛 3 | 🌐 HTML | 📅 2026-08-27 | [GitHub Pages](https://lordbasilaiassistant-sudo.github.io/x402-wiki/) | [Services](https://x402.bankr.bot/0x8f9ec800972258e48d7ebc2640ea0b5e245c2cf5/))
...
* [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 501,076 | 🐛 105 | 📅 2026-08-21 - The awesome list of awesome lists.
...
* [Awesome Web3](https://github.com/ahmet/awesome-web3) ⭐ 888 | 🐛 27 | 🌐 JavaScript | 📅 2026-08-25 - Web3 development.

* [Awesome Ethereum](https://github.com/ttumiel/Awesome-Ethereum) ⭐ 364 | 🐛 19 | 📅 2024-07-12 - Ethereum development.

* [awesome-molt-ecosystem](https://github.com/eltociear/awesome-molt-ecosystem) ⭐ 62 | 🐛 5 | 🌐 Dockerfile | 📅 2026-08-29 - Comprehensive guide to 200+ AI agent platforms with x402 economy analysis. Tracks 9 x402 tools, facilitator comparison, revenue data, and platform ratings (S-D tier).

* [gold-402](https://github.com/Haustorium12/gold-402) ⭐ 11 | 🐛 1 | 🌐 Python | 📅 2026-08-29 - Curated x402 directory by 24K Labs. 300+ handpicked entries across facilitators, SDKs, MCP servers, APIs, and tools, with editorial writeups and verified badges for production-confirmed services.
