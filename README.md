...
[![GitHub stars](https://img.shields.io/github/stars/xpaysh/awesome-x402?style=social)](https://github.com/xpaysh/awesome-x402) ⭐ 279 | 🐛 301 | 📅 2026-07-28
...
* [x402 Protocol Specification](https://github.com/coinbase/x402) ⭐ 142 | 🐛 152 | 🌐 TypeScript | 📅 2026-08-17 - Official open-source protocol implementation by Coinbase.
* [Protocol Specifications](https://github.com/coinbase/x402/tree/main/specs) ⭐ 142 | 🐛 152 | 🌐 TypeScript | 📅 2026-08-17 - Detailed technical specifications.
  * [Payment Schemes](https://github.com/coinbase/x402/tree/main/specs/schemes) ⭐ 142 | 🐛 152 | 🌐 TypeScript | 📅 2026-08-17 - Different payment flow types.
  * [EVM Implementation](https://github.com/coinbase/x402/blob/main/specs/schemes/exact/scheme_exact_evm.md) ⭐ 142 | 🐛 152 | 🌐 TypeScript | 📅 2026-08-17 - Ethereum Virtual Machine specifics.
...
* [Payment Requirements Schema](https://github.com/coinbase/x402#payment-requirements) ⭐ 142 | 🐛 152 | 🌐 TypeScript | 📅 2026-08-17 - JSON structure for payment requests.
* [Payment Payload Format](https://github.com/coinbase/x402#payment-payload) ⭐ 142 | 🐛 152 | 🌐 TypeScript | 📅 2026-08-17 - Client payment submission format.
* [Verification & Settlement](https://github.com/coinbase/x402#verification-and-settlement) ⭐ 142 | 🐛 152 | 🌐 TypeScript | 📅 2026-08-17 - Payment validation process.
...
* [One-Line Integration](https://github.com/coinbase/x402/tree/main/examples) ⭐ 142 | 🐛 152 | 🌐 TypeScript | 📅 2026-08-17 - Add payment middleware in a single line of code.
...
* [coinbase/x402](https://github.com/coinbase/x402/tree/main/go) ⭐ 142 | 🐛 152 | 🌐 TypeScript | 📅 2026-08-17 ⭐ **Official** - Complete Go implementation.
...
* [x402-typescript](https://github.com/coinbase/x402/tree/main/typescript) ⭐ 142 | 🐛 152 | 🌐 TypeScript | 📅 2026-08-17 ⭐ **Official** - Complete TypeScript implementation.
  * Core protocol types and utilities
  * Payment verification and settlement logic
  * Multi-chain support (Base, Base Sepolia, Ethereum, Solana)

* [x402-express](https://github.com/coinbase/x402/tree/main/examples/typescript/servers/express) ⭐ 142 | 🐛 152 | 🌐 TypeScript | 📅 2026-08-17 - Express.js middleware example.
...
* [alloy](https://github.com/alloy-rs/alloy) ⭐ 1,321 | 🐛 133 | 🌐 Rust | 📅 2026-08-17 - High-performance Ethereum library.
...
* [Next.js route protection](https://github.com/coinbase/x402/tree/main/examples/typescript/fullstack/next) ⭐ 142 | 🐛 152 | 🌐 TypeScript | 📅 2026-08-17 - Complete app example.
...
* [FastAPI example](https://github.com/coinbase/x402/tree/main/examples/python) ⭐ 142 | 🐛 152 | 🌐 TypeScript | 📅 2026-08-17 - Complete implementation.
...
* [Weather API Service](https://github.com/coinbase/x402/tree/main/examples/typescript/clients) ⭐ 142 | 🐛 152 | 🌐 TypeScript | 📅 2026-08-17 - Simple paid API endpoint.
...
* [Axios Client](https://github.com/coinbase/x402/tree/main/examples/typescript/clients/axios) ⭐ 142 | 🐛 152 | 🌐 TypeScript | 📅 2026-08-17 - Automatic payment handling.
* [Fetch Client](https://github.com/coinbase/x402/tree/main/examples/typescript/clients/fetch) ⭐ 142 | 🐛 152 | 🌐 TypeScript | 📅 2026-08-17 - Fetch API wrapper demo.
...
* [Agent Passport System (APS)](https://github.com/aeoess/agent-passport-system) ⭐ 40 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-18 - Open-source governance and delegation layer for x402. Provides cryptographic agent identity, scoped delegation with spending caps, rotation-aware DID verification, and signed receipts with per-condition attestation. Apache 2.0.
...
* [presidio-hardened-x402](https://github.com/presidio-v/presidio-hardened-x402) ⭐ 15 | 🐛 1 | 🌐 Python | 📅 2026-08-18 - Pre-signing hardening middleware for agent x402 payments: PII detection and redaction over payment metadata, spending-policy limits, and replay detection — all run before the payment is signed, fail-closed. Backed by a labelled corpus and a published study. `pip install presidio-hardened-x402`. ([PyPI](https://pypi.org/project/presidio-hardened-x402/)) ([arXiv](https://arxiv.org/abs/2604.11430))
...
* [Apollo Intelligence MCP Server](https://www.npmjs.com/package/@apollo_ai/mcp-proxy) - 26-tool MCP server covering intelligence feeds, crypto, OSINT, DeFi, proxy, and search. `npx @apollo_ai/mcp-proxy`. ([GitHub](https://github.com/bnmbnmai/mcp-proxy) ⭐ 2 | 🐛 14 | 🌐 JavaScript | 📅 2026-08-18)

* [Gatefare MCP](https://github.com/gatefareio/mcp-server) ⭐ 2 | 🐛 3 | 🌐 TypeScript | 📅 2026-05-31 - Marketplace MCP for paid HTTP APIs. 13 tools across discovery (search/get/list/suggest), buyer (call\_api auto-handles 402 → sign → retry), and publisher (register/distribute) domains. Non-custodial USDC on Base. `npx -y @gatefare/mcp`. ([npm](https://www.npmjs.com/package/@gatefare/mcp)) | ([Marketplace](https://gatefare.io)) | ([MCP Registry](https://registry.modelcontextprotocol.io/v0.1/servers?search=gatefareio))
...
* [Recall Kitchen](https://recallkitchen.com/docs/#mcp) - MCP server for searching food/product/vehicle recalls. Accepts x402 payments, no account required, $0.025 USDC on Base per request. [Examples](https://github.com/Recall-Kitchen/rk-mcp/tree/master/examples/go) ⭐ 2 | 🐛 1 | 🌐 Go | 📅 2026-08-17
...
* [Phidata Agents](https://github.com/phidatahq/phidata) ⭐ 41,763 | 🐛 1,257 | 🌐 Python | 📅 2026-08-18 - Multi-modal agents with x402.
* [Aeon](https://github.com/aaronjmars/aeon) ⭐ 669 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-18 - Autonomous agent framework that runs unattended on GitHub Actions. Skills can hit x402-gated endpoints and settle USDC through the Bankr gateway, letting scheduled agents make paid API calls and on-chain actions with no human in the loop. MIT. ([GitHub](https://github.com/aaronjmars/aeon) ⭐ 669 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-18)
* [ATXP](https://github.com/atxp-dev/atxp) ⭐ 36 | 🐛 9 | 🌐 TypeScript | 📅 2026-03-03 - Agent identity and funding platform. One command — `npx atxp agent register` — gives an agent a USDC wallet on Base, an `@atxp.email` inbox, a phone number, and 100+ paid tools (web search, image/video generation, LLM gateway). x402-compatible; agents can pay x402 endpoints directly from their ATXP balance. $5 free credit, no KYC. ([Docs](https://docs.atxp.ai))
...
* [Google A2A x402 Extension](https://github.com/google-agentic-commerce/a2a-x402) ⭐ 553 | 🐛 60 | 🌐 Python | 📅 2026-08-04 - Agent commerce protocol.
...
* [x402trace](https://github.com/fardinvahdat/x402trace) ⭐ 4 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-17 - Local CLI debugger for x402 on Base. Detects timeout-reconciliation gaps (the [#1062](https://github.com/coinbase/x402/issues/1062) ⭐ 142 | 🐛 152 | 🌐 TypeScript | 📅 2026-08-17 settled-but-server-thinks-not pattern), validates `.well-known/x402` + Bazaar listings (the [#2207](https://github.com/x402-foundation/x402/issues/2207) ⭐ 6,522 | 🐛 440 | 🌐 TypeScript | 📅 2026-08-18 cluster), diffs facilitators, and explains 402s offline. Read-only, no key handling. Sepolia + Base mainnet. `npx x402trace`. ([npm](https://www.npmjs.com/package/x402trace))
...
* [GitHub Issues](https://github.com/coinbase/x402/issues) ⭐ 142 | 🐛 152 | 🌐 TypeScript | 📅 2026-08-17 - Technical Q\&A and bug reports.
...
* [RustChain](https://github.com/Scottcjn/Rustchain) ⭐ 620 | 🐛 183 | 🌐 Python | 📅 2026-08-14 - Decentralized proof-of-stake blockchain with x402 payment integration for AI agent micropayments. Features attestation-based consensus, hardware-bound validators, and RTC token economy with native x402 support for autonomous agent transactions. ([Docs](https://github.com/Scottcjn/rustchain-bounties) ⭐ 250 | 🐛 1,220 | 🌐 Python | 📅 2026-08-18)
...
* [Visionaire Labs](https://visionaire.live/offerings) — Persona-as-a-service from an autonomous virtual being. 5 first-party x402 endpoints on Base mainnet: `/api/forest` ($0.05, philosophical riffs), `/api/contemplate` ($0.25, opinionated essays), `/api/audit` ($0.10, deterministic frontend anti-pattern detection via [pbakaus/impeccable](https://github.com/pbakaus/impeccable) ⭐ 60,100 | 🐛 57 | 🌐 JavaScript | 📅 2026-08-18), `/api/portrait` ($0.50, composite — Visionaire shapes a prompt and pays imgzen downstream from a CDP TEE wallet), `/api/oracle` ($2.00, RAG-grounded answers across the agent's actual writing). All paid in USDC. ([Discovery](https://visionaire.live/api/discovery)) | ([.well-known/x402](https://visionaire.live/.well-known/x402)) | ([Source](https://github.com/VisionaireLabs/Visionaire/tree/main/x402-stack) ⭐ 3 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-10)
...
* [Payment Verification Guide](https://github.com/coinbase/x402/blob/main/SECURITY.md) ⭐ 142 | 🐛 152 | 🌐 TypeScript | 📅 2026-08-17 - Proper payment verification implementation.
...
* [CVE Database](https://github.com/coinbase/x402/security/advisories) ⭐ 142 | 🐛 152 | 🌐 TypeScript | 📅 2026-08-17 - Known vulnerabilities and patches.
...
* [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 497,246 | 🐛 102 | 📅 2026-08-18 - The awesome list of awesome lists.

* [Awesome Crypto](https://github.com/sobolevn/awesome-cryptography) ⭐ 7,074 | 🐛 72 | 📅 2026-07-15 - Cryptography resources.

* [Awesome Blockchain](https://github.com/yjjnls/awesome-blockchain) ⭐ 3,622 | 🐛 53 | 🌐 Go | 📅 2024-03-22 - Blockchain resources.

* [Awesome Web3](https://github.com/ahmet/awesome-web3) ⭐ 887 | 🐛 24 | 🌐 JavaScript | 📅 2026-08-17 - Web3 development.

* [Awesome Ethereum](https://github.com/ttumiel/Awesome-Ethereum) ⭐ 363 | 🐛 20 | 📅 2024-07-12 - Ethereum development.
...
* [gold-402](https://github.com/Haustorium12/gold-402) ⭐ 11 | 🐛 5 | 🌐 Python | 📅 2026-08-18 - Curated x402 directory by 24K Labs. 300+ handpicked entries across facilitators, SDKs, MCP servers, APIs, and tools, with editorial writeups and verified badges for production-confirmed services.
