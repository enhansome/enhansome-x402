...
[![GitHub stars](https://img.shields.io/github/stars/xpaysh/awesome-x402?style=social)](https://github.com/xpaysh/awesome-x402) ⭐ 283 | 🐛 336 | 📅 2026-07-28
...
* [x402 Protocol Specification](https://github.com/coinbase/x402) ⭐ 145 | 🐛 157 | 🌐 TypeScript | 📅 2026-08-21 - Official open-source protocol implementation by Coinbase.
* [Protocol Specifications](https://github.com/coinbase/x402/tree/main/specs) ⭐ 145 | 🐛 157 | 🌐 TypeScript | 📅 2026-08-21 - Detailed technical specifications.
  * [Payment Schemes](https://github.com/coinbase/x402/tree/main/specs/schemes) ⭐ 145 | 🐛 157 | 🌐 TypeScript | 📅 2026-08-21 - Different payment flow types.
  * [EVM Implementation](https://github.com/coinbase/x402/blob/main/specs/schemes/exact/scheme_exact_evm.md) ⭐ 145 | 🐛 157 | 🌐 TypeScript | 📅 2026-08-21 - Ethereum Virtual Machine specifics.
...
* [Payment Requirements Schema](https://github.com/coinbase/x402#payment-requirements) ⭐ 145 | 🐛 157 | 🌐 TypeScript | 📅 2026-08-21 - JSON structure for payment requests.
* [Payment Payload Format](https://github.com/coinbase/x402#payment-payload) ⭐ 145 | 🐛 157 | 🌐 TypeScript | 📅 2026-08-21 - Client payment submission format.
* [Verification & Settlement](https://github.com/coinbase/x402#verification-and-settlement) ⭐ 145 | 🐛 157 | 🌐 TypeScript | 📅 2026-08-21 - Payment validation process.
...
* [One-Line Integration](https://github.com/coinbase/x402/tree/main/examples) ⭐ 145 | 🐛 157 | 🌐 TypeScript | 📅 2026-08-21 - Add payment middleware in a single line of code.
...
* [coinbase/x402](https://github.com/coinbase/x402/tree/main/go) ⭐ 145 | 🐛 157 | 🌐 TypeScript | 📅 2026-08-21 ⭐ **Official** - Complete Go implementation.
...
* [x402-typescript](https://github.com/coinbase/x402/tree/main/typescript) ⭐ 145 | 🐛 157 | 🌐 TypeScript | 📅 2026-08-21 ⭐ **Official** - Complete TypeScript implementation.
  * Core protocol types and utilities
  * Payment verification and settlement logic
  * Multi-chain support (Base, Base Sepolia, Ethereum, Solana)

* [x402-express](https://github.com/coinbase/x402/tree/main/examples/typescript/servers/express) ⭐ 145 | 🐛 157 | 🌐 TypeScript | 📅 2026-08-21 - Express.js middleware example.
...
* [x402-rs](https://github.com/x402-rs/x402-rs) ⭐ 286 | 🐛 28 | 🌐 Rust | 📅 2026-07-13 ⭐ **Community** - Production-grade Rust implementation.
  * Axum middleware
...
* [Sirenic](https://api.sirenic.eu) - Official French & European company data for AI agents, from open government sources (INSEE/INPI, Etalab 2.0). Search 30M French companies, full profiles, KYB files with sanctions screening (5 official lists, scored matches), filed financials, BODACC legal alerts, sector benchmarks, failure-risk score, AI health summaries, PDF reports; European registers (BE/UK/NO/EE/LV) + worldwide GLEIF in one unified schema. $0.001–$0.50 USDC per call on Base mainnet via x402 v2 — no account, no API key; failed requests are never charged. MCP server with 25 tools. ([llms.txt](https://api.sirenic.eu/llms.txt)) ([OpenAPI](https://api.sirenic.eu/openapi.json)) ([MCP](https://api.sirenic.eu/mcp)) ([Examples](https://github.com/sirenic-eu/sirenic-examples) ⭐ 0 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-21)
...
* [alloy](https://github.com/alloy-rs/alloy) ⭐ 1,320 | 🐛 134 | 🌐 Rust | 📅 2026-08-22 - High-performance Ethereum library.
...
* [Next.js route protection](https://github.com/coinbase/x402/tree/main/examples/typescript/fullstack/next) ⭐ 145 | 🐛 157 | 🌐 TypeScript | 📅 2026-08-21 - Complete app example.
...
* [FastAPI example](https://github.com/coinbase/x402/tree/main/examples/python) ⭐ 145 | 🐛 157 | 🌐 TypeScript | 📅 2026-08-21 - Complete implementation.
...
* [Running Your Own Facilitator](https://github.com/x402-rs/x402-rs#facilitator) ⭐ 286 | 🐛 28 | 🌐 Rust | 📅 2026-07-13 - Setup guide.
...
* [Weather API Service](https://github.com/coinbase/x402/tree/main/examples/typescript/clients) ⭐ 145 | 🐛 157 | 🌐 TypeScript | 📅 2026-08-21 - Simple paid API endpoint.
...
* [Axios Client](https://github.com/coinbase/x402/tree/main/examples/typescript/clients/axios) ⭐ 145 | 🐛 157 | 🌐 TypeScript | 📅 2026-08-21 - Automatic payment handling.
* [Fetch Client](https://github.com/coinbase/x402/tree/main/examples/typescript/clients/fetch) ⭐ 145 | 🐛 157 | 🌐 TypeScript | 📅 2026-08-21 - Fetch API wrapper demo.
...
* [Apollo Intelligence MCP Server](https://www.npmjs.com/package/@apollo_ai/mcp-proxy) - 26-tool MCP server covering intelligence feeds, crypto, OSINT, DeFi, proxy, and search. `npx @apollo_ai/mcp-proxy`. ([GitHub](https://github.com/bnmbnmai/mcp-proxy) ⭐ 2 | 🐛 86 | 🌐 JavaScript | 📅 2026-08-23)
...
* [Phidata Agents](https://github.com/phidatahq/phidata) ⭐ 41,847 | 🐛 1,287 | 🌐 Python | 📅 2026-08-23 - Multi-modal agents with x402.
* [Aeon](https://github.com/aaronjmars/aeon) ⭐ 678 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-22 - Autonomous agent framework that runs unattended on GitHub Actions. Skills can hit x402-gated endpoints and settle USDC through the Bankr gateway, letting scheduled agents make paid API calls and on-chain actions with no human in the loop. MIT. ([GitHub](https://github.com/aaronjmars/aeon) ⭐ 678 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-22)
* [ATXP](https://github.com/atxp-dev/atxp) ⭐ 37 | 🐛 8 | 🌐 TypeScript | 📅 2026-03-03 - Agent identity and funding platform. One command — `npx atxp agent register` — gives an agent a USDC wallet on Base, an `@atxp.email` inbox, a phone number, and 100+ paid tools (web search, image/video generation, LLM gateway). x402-compatible; agents can pay x402 endpoints directly from their ATXP balance. $5 free credit, no KYC. ([Docs](https://docs.atxp.ai))
...
* [Google A2A x402 Extension](https://github.com/google-agentic-commerce/a2a-x402) ⭐ 553 | 🐛 59 | 🌐 Python | 📅 2026-08-04 - Agent commerce protocol.
...
* [x402trace](https://github.com/fardinvahdat/x402trace) ⭐ 5 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-17 - Local CLI debugger for x402 on Base. Detects timeout-reconciliation gaps (the [#1062](https://github.com/coinbase/x402/issues/1062) ⭐ 145 | 🐛 157 | 🌐 TypeScript | 📅 2026-08-21 settled-but-server-thinks-not pattern), validates `.well-known/x402` + Bazaar listings (the [#2207](https://github.com/x402-foundation/x402/issues/2207) ⭐ 6,536 | 🐛 459 | 🌐 TypeScript | 📅 2026-08-21 cluster), diffs facilitators, and explains 402s offline. Read-only, no key handling. Sepolia + Base mainnet. `npx x402trace`. ([npm](https://www.npmjs.com/package/x402trace))
...
* [GitHub Issues](https://github.com/coinbase/x402/issues) ⭐ 145 | 🐛 157 | 🌐 TypeScript | 📅 2026-08-21 - Technical Q\&A and bug reports.
...
* [RustChain](https://github.com/Scottcjn/Rustchain) ⭐ 719 | 🐛 187 | 🌐 Python | 📅 2026-08-23 - Decentralized proof-of-stake blockchain with x402 payment integration for AI agent micropayments. Features attestation-based consensus, hardware-bound validators, and RTC token economy with native x402 support for autonomous agent transactions. ([Docs](https://github.com/Scottcjn/rustchain-bounties) ⭐ 251 | 🐛 1,173 | 🌐 Python | 📅 2026-08-23)
...
* [Visionaire Labs](https://visionaire.live/offerings) — Persona-as-a-service from an autonomous virtual being. 5 first-party x402 endpoints on Base mainnet: `/api/forest` ($0.05, philosophical riffs), `/api/contemplate` ($0.25, opinionated essays), `/api/audit` ($0.10, deterministic frontend anti-pattern detection via [pbakaus/impeccable](https://github.com/pbakaus/impeccable) ⭐ 61,782 | 🐛 69 | 🌐 JavaScript | 📅 2026-08-22), `/api/portrait` ($0.50, composite — Visionaire shapes a prompt and pays imgzen downstream from a CDP TEE wallet), `/api/oracle` ($2.00, RAG-grounded answers across the agent's actual writing). All paid in USDC. ([Discovery](https://visionaire.live/api/discovery)) | ([.well-known/x402](https://visionaire.live/.well-known/x402)) | ([Source](https://github.com/VisionaireLabs/Visionaire/tree/main/x402-stack) ⭐ 3 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-10)
...
* [Payment Verification Guide](https://github.com/coinbase/x402/blob/main/SECURITY.md) ⭐ 145 | 🐛 157 | 🌐 TypeScript | 📅 2026-08-21 - Proper payment verification implementation.
...
* [CVE Database](https://github.com/coinbase/x402/security/advisories) ⭐ 145 | 🐛 157 | 🌐 TypeScript | 📅 2026-08-21 - Known vulnerabilities and patches.
...
* [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 499,156 | 🐛 106 | 📅 2026-08-21 - The awesome list of awesome lists.

* [Awesome Crypto](https://github.com/sobolevn/awesome-cryptography) ⭐ 7,085 | 🐛 71 | 📅 2026-07-15 - Cryptography resources.
...
* [gold-402](https://github.com/Haustorium12/gold-402) ⭐ 11 | 🐛 13 | 🌐 Python | 📅 2026-08-21 - Curated x402 directory by 24K Labs. 300+ handpicked entries across facilitators, SDKs, MCP servers, APIs, and tools, with editorial writeups and verified badges for production-confirmed services.
